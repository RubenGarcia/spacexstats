...
class PartFlightsTableSeeder extends Seeder {
    public function run() {
        ...
        PartFlight::create(array(
            'mission_id' => 27,
            'part_id' => Part::where('name', 'F9-022')->first()->part_id,
            'firststage_engine' => Engine::Merlin1DFullThrust,
            'landed' => false
        ));
        ...
        PartFlight::create(array(
            'mission_id' => 27,
            'part_id' => Part::where('name', 'F9-022-US')->first()->part_id,
            'upperstage_engine' => Engine::Merlin1DVacFullThrust,
            'landed' => false
        ));
        ...
        PartFlight::create(array(
            'mission_id' => 30,
            'part_id' => Part::where('name', 'F9-025')->first()->part_id,
            'firststage_engine' => Engine::Merlin1DFullThrust,
            'landed' => true
        ));
        ...
        PartFlight::create(array(
            'mission_id' => 30,
            'part_id' => Part::where('name', 'F9-025-US')->first()->part_id,
            'upperstage_engine' => Engine::Merlin1DVacFullThrust,
            'landed' => false
        ));
        ...
        PartFlight::create(array(
            'mission_id' => 32,
            'part_id' => Part::where('name', 'F9-027')->first()->part_id,
            'firststage_engine' => Engine::Merlin1DFullThrust,
            'landed' => true
        ));
        ...
        PartFlight::create(array(
            'mission_id' => 32,
            'part_id' => Part::where('name', 'F9-027-US')->first()->part_id,
            'upperstage_engine' => Engine::Merlin1DVacFullThrust,
            'landed' => false
        ));
    }
